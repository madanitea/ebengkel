...
include '../../Controller/read_perizinan_aspiran.php';
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body">
						<a href="" id="navbar-menu" class="btn btn-success form-control"><i class="ti-check"></i> &nbsp Perizinan</a>
					...
					<div class="card-body">
						...
						<table class="table">
							...
							<tr>
								...
								<td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#izin<?php echo $data['id_peminjaman'];?>"><i class='ti-eye'></i></button>
									<a href="../../Controller/izinkan_aspiran.php?id_peminjaman=<?php echo $data['id_peminjaman'];?>" class="btn btn-success"><i class="ti-check"></i> Pinjamkan</a><a href="../../Controller/batal_peminjaman_aspiran.php?id_peminjaman=<?php echo $data['id_peminjaman'];?>" class="btn btn-danger"><i class="ti-trash"></i> Tolak</a></td>
							</tr>
