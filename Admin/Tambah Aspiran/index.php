...
<html>
<head>
	<title>Tambah Aspiran | E-Bengkel</title>
	<meta charset="utf-8">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card">
					...
					<li>
						...
						<div class="dropright">
						<button type="button" class="btn btn-primary form-control" id="navbar-menu" data-toggle="dropdown"><i class="ti-briefcase"></i>&nbsp&nbsp&nbspAspiran</span></button>
						<ul class="dropdown-menu">
							<li>
						<a href="../Data Aspiran" id="navbar-menu" class="btn btn-default form-control"><i class="ti-briefcase"></i> &nbsp Data Aspiran</a>
						</li>
						<li>
						<a href="" id="navbar-menu" class="btn btn-default form-control"><i class="ti-cloud-up"></i> &nbsp Tambah Aspiran</a></li>
						</ul>
						</div>
					</div>
			...
			<div class="col-md-9">
				<div class="card">
					<div id="card-header" class="card-header">
						<div class="title">
							<i class="ti-cloud-up"></i> &nbsp Tambah Aspiran
						</div>
					</div>
					<div class="card-body">
						<form class="form-group" action="../../Controller/tambah_aspiran.php" method="POST">
							<center><img src="../../img/barang.gif" width="30%"></center>
							<label>Nama :</label>
							<input class="form-control" type="text" name="nama" placeholder="Masukan nama aspiran"><br>
							<label>No Telepon :</label>
							<input class="form-control" type="number" name="no_telp" placeholder="Masukan no telepon aspiran"><br>
							<label>Email :</label>
							<input class="form-control" type="email" name="email" placeholder="Masukan email aspiran"><br>
							<label>Password :</label>
							<input class="form-control" type="password" name="password" placeholder="Masukan password aspiran"><br>
