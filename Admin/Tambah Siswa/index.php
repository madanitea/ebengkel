...
<html>
<head>
	<title>Tambah Siswa | E-Bengkel</title>
	<meta charset="utf-8">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card">
					...
					<li>
						...
						<a href="" id="navbar-menu" class="btn btn-default form-control"><i class="ti-cloud-up"></i> &nbsp Tambah Siswa</a>
						</li>
					</ul>
						</div>
						<div class="dropright">
			...
			<div class="col-md-9">
				<div class="card">
					<div id="card-header" class="card-header">
						<div class="title">
							<i class="ti-cloud-up"></i> &nbsp Tambah Siswa
						</div>
					</div>
					<div class="card-body">
						<form class="form-group" action="../../Controller/tambah_siswa.php" method="POST">
							<center><img src="../../img/barang.gif" width="30%"></center>
							<label>Nama :</label>
							<input class="form-control" type="text" name="nama" placeholder="Masukan nama siswa"><br>
							<label>Angkatan :</label>
							<input type="number" class="form-control" min="1" name="tingkat"><br>
							<label>Kelas :</label>
							<select class="form-control" name="kelas">
								<option>SIJA A</option>
								<option>SIJA B</option>
								<option>SIJA C</option>
								<option>SIJA D</option>
							</select><br>
							<label>No Telepon :</label>
							<input class="form-control" type="number" name="no_telp" placeholder="Masukan no telepon siswa"><br>
							<label>Email :</label>
							<input class="form-control" type="email" name="email" placeholder="Masukan email siswa"><br>
							<label>Password :</label>
							<input class="form-control" type="password" name="password" placeholder="Masukan masukan password siswa"><br>
