...
include '../../Controller/read_siswa.php';
  session_start();
...
<html>
<head>
	<title>Data Siswa | E-Bengkel</title>
	<meta charset="utf-8">
...
<body>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card">
					...
					<li>
						...
						<div class="dropright">
							<button type="button" class="btn btn-primary form-control" id="navbar-menu" data-toggle="dropdown"><i class="ti-user"></i>&nbsp&nbsp&nbspSiswa</button>
							<ul class="dropdown-menu">
								<li>
						<a href="" id="navbar-menu" class="btn btn-default form-control"><i class="ti-eye"></i> &nbsp Data Siswa</a></li>
						<li>
			...
			<div class="col-md-9">
				<div class="card">
					<div id="card-header" class="card-header">
						<div class="title">
							<i class="ti-user"></i> &nbsp Data Siswa
						</div>
					</div>
					<div class="card-body">
            ...
            <div class="btn-group ml-4" role="group" aria-label="Aksi">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
						    ...
						    <a id="action" href="../../Controller/hapus_siswa.php?id=<?php echo $data['id'];?>"<button id="action" type="button" class="btn btn-danger">Hapus</button></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal fade" id="u<?php echo $data['id'];?>" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						    <h5 class="modal-title" id="exampleModalLabel"><i class="ti-pencil-alt"></i>  Perbaharui Data Siswa</h5>
						    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						    </button>
						</div>
	...
	<div class="modal fade" id="import" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						    <h5 class="modal-title" id="exampleModalLabel"><i class="ti-pencil-alt"></i>  Import Data Siswa Dari File.CSV</h5>
						    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						    </button>
						</div>
						<div class="modal-body">
						  	<form action="../../Controller/import_siswa.php" method="POST" enctype="multipart/form-data">
						  	<label>Pilih file :</label>
						  	<input type="file" name="file" required="Pilih File">
						  	<br>
						  	Format penulisan : <br>Email | Nama | Password | Angkatan | Kelas | No Telepon<br><br>
						  	Ditulis tanpa header ! Contoh :<br>
						  	<img src="../../img/import2.PNG" width="100%"><br><br>
			...
			<div class="modal fade" id="export" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
						  	<form action="../../Controller/export_siswa.php" method="POST" enctype="multipart/form-data">
