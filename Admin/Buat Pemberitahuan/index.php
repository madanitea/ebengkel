...
<html>
<head>
	<title>Buat Pemberitahuan | E-Bengkel</title>
	<meta charset="utf-8">
		...
		<div class="row">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<ul class="dropdown-menu">
							<li>
						<a href="" id="navbar-menu" class="btn btn-default form-control"><i class="ti-share-alt"></i> &nbsp Buat Pemberitahuan</a></li>
						<li>
			...
			<div class="col-md-9">
				<div class="card">
					<div id="card-header" class="card-header">
						<div class="title">
							<i class="ti-share-alt"></i> &nbsp Buat Pemberitahuan
						</div>
					</div>
					<div class="card-body">
						<form class="form-group" action="../../Controller/post_pemberitahuan.php" method="POST">
							<center><img src="../../img/post.gif" width="20%"></center>
							<p>Untuk membuat pemberitahuan, silahkan isi formulir dibawah ini. Atau anda juga bisa menghapus pemberitahuan yang sudah tidak berlaku lagi, dengan menggunakan halaman data pemberitahuan.</p>
							<input class="form-control" type="textarea" name="konten"><br>
							<button type="submit" id="action" class="btn btn-success float-right"><i class="ti-announcement"></i>&nbsp POST</button>
						</form>
					</div>
					<div class="card-footer">
						<div class="title">
