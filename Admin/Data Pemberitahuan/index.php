...
<html>
<head>
	<title>Data Pemberitahuan | E-Bengkel</title>
	<meta charset="utf-8">
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card">
					...
					<div class="card-body">
						<div class="dropright">
						<button type="button" class="btn btn-primary form-control" id="navbar-menu" data-toggle="dropdown"><i class="ti-email"></i>&nbsp&nbsp&nbspPemberitahuan</button>
						...
						<li>
						<a href="" id="navbar-menu" class="btn btn-default form-control"><i class="ti-eye"></i> &nbsp Data Pemberitahuan</a></li>
						</ul>
						</div>
			...
			<div class="col-md-9">
				<div class="card">
					<div id="card-header" class="card-header">
						<div class="title">
							<i class="ti-eye"></i> &nbsp Data Pemberitahuan
						</div>
					</div>
					<div class="card-body">
                ...
                <option value="100">100</option>
							...
							<button class="float-right" type="submit" id="cari-go" name="cari"><i class="ti-search"></i></button>
							<input type="text" name="cari" id="cari" class="float-right" placeholder="Cari data..">
						</form>
						<div class="perhalus-bawah"></div>
						<table class="table table-striped table-borderless" id="data-pemberitahuan">
							<thead><!-- 
							<tr>
								<th>No</th>
								<th>Konten</th>
						...
						<tbody>
								...
								while ($data = mysqli_fetch_array($result)){
									?><tr id="data">
                                    <td><?php echo $no;?></td>
                                    <td><?php echo $data['konten'];?><br><b><?php echo $data['tanggal'];?></b></td>
                                    <td><button id="action" type="button" class="btn btn-danger" data-toggle="modal" data-target="#del<?php echo $data['id'];?>"><i class='ti-trash'></i></button>
                                    </td>
                                  </tr>
                                  	<!-- Modal Delete -->
			<div class="modal fade" id="del<?php echo $data['id'];?>" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
						  	<p>Anda yakin ingin menghapus data <?php echo $data['id'];?>?</p>
						</div>
						<div class="modal-footer">
						    <button id="action" type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
						    <a id="action" href="../../Controller/hapus_pemberitahuan.php?id=<?php echo $data['id'];?>"><button type="button" class="btn btn-danger">Hapus</button></a>
						</div>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		function search_table(value){
			$('#data-pemberitahuan #data').each(function(){
				var ditemukan = 'false';
				$(this).each(function(){
