...
include '../../Controller/read_admin.php';
		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="card">
					...
					<div class="card-body">
						<form class="form-group" action="../../Controller/update_admin.php" method="POST">
							<center><img src="../../img/profil.gif" width="30%"></center>
							<label>ID :</label>
							<input class="form-control" type="text" name="iod" value="<?php echo $idd ?>" disabled><br>
							<input class="form-control" type="hidden" name="id" value="<?php echo $idd ?>"><br>
							<label>Jabatan :</label>
							<input class="form-control" type="text" name="level" value="<?php echo $level ?>" disabled><br>
							<label>Nama :</label>
							<input class="form-control" type="text" name="nama" value="<?php echo $nama ?>"><br>
							<label>No Telepon :</label>
							<input class="form-control" type="number" name="no_telp" value="<?php echo $no_hp ?>" value="082118671270"><br>
							<label>Email :</label>
