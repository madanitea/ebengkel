		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="card">
					...
					<li>
						...
						<ul class="dropdown-menu">
							<li>
						<a href="" id="navbar-menu" class="btn btn-default form-control"><i class="ti-briefcase"></i> &nbsp Data Aspiran</a>
						</li>
						<li>
			...
			<div class="col-md-9">
                ...
                <option value="100">100</option>
						...
						<table class="table" id="data-aspiran">
							<thead>
							<tr>
								<th>No</th>
								<th>Nama</th>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
						  	<p>Anda yakin ingin menghapus <?php echo $data['nama'];?> dengan ID <?php echo $data['id'];?> dari database?</p>
						</div>
						<div class="modal-footer">
						    <a id="action"><button id="action" type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button></a>
						    <a id="action" href="../../Controller/hapus_aspiran.php?id=<?php echo $data['id'];?>"><button id="action" type="button" class="btn btn-danger">Hapus</button></a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="modal fade" id="u<?php echo $data['id'];?>" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						    <h5 class="modal-title" id="exampleModalLabel"><i class="ti-pencil-alt"></i>  Perbaharui Data Aspiran</h5>
						    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						    </button>
						</div>
						<div class="modal-body">
						  	<form action="../../Controller/update_aspiran.php" method="POST">
